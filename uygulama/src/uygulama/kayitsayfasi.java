...
public class kayitsayfasi extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/baglanti", "root", "145304")) {
            String query = "INSERT INTO kullanicilar (username, password, money) VALUES ('"+username+"','"+password+"', '"+0+"')";
